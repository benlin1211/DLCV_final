...
class ScannetVoxelizationDataset(VoxelizationDataset):
    ...
    def __init__(self,
        ...
        # print("123",instance_sampling_weights_path)
        if os.path.isfile(instance_sampling_weights_path) and config.sample_tail_instances:
            with open(instance_sampling_weights_path, "rb") as input_file:
                ...
                # for l in instance_sampling_weights.items():
                #     print(l, end=" ")
    ...
    def add_instances_to_cloud(self, coords, feats, labels, scene_name, transformations):
        ...
        # print(self.VALID_CLASS_IDS)
        # print(self.instance_sampling_weights.shape)
        # print("sss",self.instance_sampling_weights)
        ...
        for sample in samples:
            ...
            # print(random.choice(os.listdir(cat_path)))
            ...
            # print("bbb",inst_labels.shape, labels_b==inst_labels)
    ...
    def __getitem__(self, index):
        ...
        if self.config.instance_augmentation is not None and self.augment_data:
            ...
            if self.config.instance_augmentation == 'raw':
                ...
                labels = labels[:, 0]
            # print("aaa",labels.shape, labels_a==labels)
    ...
    def test_pointcloud(self, pred_dir, num_labels):
        ...
        for i, data_path in enumerate(self.data_paths):
            ...
            # save voxelized pointcloud predictions (voxelized visualization)
            save_point_cloud(
            ...
            # Save prediciton in txt format (submission).
            np.savetxt(f'{eval_path}/{room_id}.txt', ptc_pred, fmt='%i')
            # Save prediciton in colored pointcloud (visualization).
            save_point_cloud(
